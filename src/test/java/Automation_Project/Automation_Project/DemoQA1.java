...
public class DemoQA1 {
	...
	public static void main(String[] args) {

		{
			...
			WebElement Y = driver.findElement(By.xpath("//select[@class=\"react-datepicker__year-select\"]"));
			...
			driver.findElement(By.xpath("//div[@aria-label=\"Choose Saturday, March 11th, 2000\"]")).click();
...
//			driver.findElement(By.xpath("//div[@id=\"subjectsContainer\"]")) .sendKeys("Physics");
